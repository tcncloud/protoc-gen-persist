...
func (p *ExampleTable1ForExampleService1) GetMappedenum() interface{}      { return p.Mappedenum }
func (p *ExampleTable1ForExampleService1) SetMappedenum(param interface{}) { p.Mappedenum = param }
