...
o.Name = res.Name
        ...
        func (this *Amazing_SelectByIdRow) test.ExampleTable() (*test.ExampleTable, error) {
                if this.err != nil {
                    return nil, this.err
                }
...
o.Name = res.Name
        ...
        func (this *Amazing_SelectByNameRow) test.ExampleTable() (*test.ExampleTable, error) {
                if this.err != nil {
                    return nil, this.err
                }
                return &test.ExampleTable{
...
GetName() string
        ...
        func (this *Amazing_InsertRow) test.NumRows() (*test.NumRows, error) {
                if this.err != nil {
                    return nil, this.err
                }
                return &test.NumRows{
            ...
            func (this *Amazing_InsertRow) test.Ids() (*test.Ids, error) {
                if this.err != nil {
                    return nil, this.err
                }
                return &test.Ids{
