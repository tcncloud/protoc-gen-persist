...
protoc --include_imports -I. -I$GOPATH/src \
			 -I$GOPATH/src/github.com/coltonmorris/protoc-gen-persist --include_source_info \
...
protoc --include_imports -I. -I$GOPATH/src \
			 -I$GOPATH/src/github.com/coltonmorris/protoc-gen-persist --include_source_info \
			 -I$GOPATH/src/github.com/coltonmorris/protoc-gen-persist/examples/test \
			 -I$GOPATH/src/github.com/coltonmorris/protoc-gen-persist/examples \
