...
func (MyEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_basic_example_9f59e3a70ce87c48, []int{0}
}
...
func (MappedEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_basic_example_9f59e3a70ce87c48, []int{1}
}
...
func (*Something_SomethingElse) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_example_9f59e3a70ce87c48, []int{1, 0}
}
...
func (*HasTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_example_9f59e3a70ce87c48, []int{2}
}
...
func init() {
	proto.RegisterFile("tests/spanner/basic/basic_example.proto", fileDescriptor_basic_example_9f59e3a70ce87c48)
}

var fileDescriptor_basic_example_9f59e3a70ce87c48 = []byte{
